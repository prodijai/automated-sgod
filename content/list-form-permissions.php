...
$permissions = mysqli_query($conn,"SELECT * FROM system_permissions WHERE permission_type = '1' ORDER BY name");
          ...
          <div class="row">
            <div class="col-12">
              ...
              <form action="system/functions.php" method="post" name="table_1">
                <input type="hidden" class="form-control" id="form_id" name="form_id" readonly value="<?php echo $_GET['fid'];?>">
                <input type="hidden" class="form-control" id="form_code" name="form_code" readonly value="<?php echo $_GET['f'];?>">
...
<!--                   <th>List All</th>
                  ...
                  while($entity = mysqli_fetch_array($entities)){
                    ...
                    echo "<tr>";
                      ...
                      while($permission = mysqli_fetch_array($permissions)){
                        ...
                        $checked_value = returnIfChecked($permission['id'],$entity['id'],$form_id,$school['id']);
              ...
              <button type="submit" class="btn btn-primary mb-2" name="save_form_permission">Save Permission Configuration</button>
              </form>
            </div>            
<!--             <div class="col-4">
              <?php 
