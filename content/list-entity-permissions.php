...
$permissions = mysqli_query($conn,"SELECT * FROM system_permissions WHERE permission_type = '2' ORDER BY name");
  ...
  for (var i=0; i<checkboxes.length; i++)  {
    if (checkboxes[i].type == 'checkbox')   {
      checkboxes[i].checked = checktoggle;
          ...
          <div class="row">
            <div class="col-12">
              <h2>Entity Permissions and Access Control</h2>
              <p>This permissions will only be applied to the entity.</p>
              ...
              <form action="system/functions.php" method="post" name="table_1">
                ...
                <input type="hidden" class="form-control" id="entity_code" name="entity_code" readonly value="<?php echo $_GET['e'];?>">
...
<!--                   <th>List All</th>
                  ...
                  while($entity = mysqli_fetch_array($entities)){
                    ...
                    echo "<tr>";
                      ...
                      while($permission = mysqli_fetch_array($permissions)){
                        ...
                        $checked_value = returnIfChecked($permission['id'],$entity['id'],$entity_id,$school['id']);
              ...
              <button type="submit" class="btn btn-primary mb-2" name="save_entity_permission">Save Permission Configuration</button>
              </form>
            </div>            
<!--             <div class="col-4">
              <?php 
